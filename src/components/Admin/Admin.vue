...
<template>
            ...
            <ul>
                ...
                <li>
                    <a href="#">
                        ...
                        <router-link class="title" to="/Admin/Inventory">inventori</router-link>
    ...
    <div class="main1">
        ...
        <div class="topbar">
            ...
            <!-- userImg -->
            <div class="dropdown">
                <img src="../../assets/images/user.jpg" type="button" class="user btn-secondary dropdown-toggle"
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <ion-icon name="chatbox-ellipses"></ion-icon>Inbox
                    </li>
                    <li  @click="logout()">
                        <ion-icon name="exit"></ion-icon>Sing Out 
                    </li>
                </ul>
            </div>
        </div>
